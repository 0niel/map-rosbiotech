            ...
            >
              ...
              <Dialog.Panel className="relative transform rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                ...
                <div className="space-y-6 px-6 py-6 lg:px-8">
                  <p>
                    Выберите дату и время, для которых будет отображена карта:
                  </p>
                  ...
                  <button
                    ref={mainButtonRef}
                    type="submit"
                    className="w-full rounded-lg bg-green-500 px-5 py-2.5 text-center text-sm font-medium  text-white hover:bg-green-600 focus:outline-none focus:ring-4 focus:ring-green-300"
                    onClick={() => {
