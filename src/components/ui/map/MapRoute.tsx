        ...
        renderRoute: (startMapObject, endMapObject, currentFloor) => {
            ...
            for (const pathSegment of path) {
                ...
                const lastCurrentFloorPoint =
                    pathSegment[pathSegment.length - 1] ||
                    ({ x: 0, y: 0 } as Vertex)
                ...
                if (endFloor < currentFloor) {
                    ...
                    const pointAfterCurrentSegment =
                        allPoints[
                            allPoints.indexOf(currentSegmentLastPoint) + 1
                        ]
                    if (pointAfterCurrentSegment) {
                        const pointFloor = mapData.getFloorByPoint(
                            pointAfterCurrentSegment
                        )
