...
const getCurrentEvent = (
    ...
    const currentLessons = lessons.filter(lesson => {
        ...
        const [lessonStartHours, lessonStartMinutes] =
            lessonStartTime.split(':')
                            ...
                            <Dropdown.Item className="pointer-events-none">
                                <div className="flex flex-col items-center">
                                    ...
                                    <p className="mt-2 text-sm text-gray-900">
                                        Этот QR-код можно отсканировать, чтобы
                                        открыть эту аудиторию на карте
                                    </p>
                                </div>
                            </Dropdown.Item>
                        </Dropdown>
                ...
                <Tabs>
                    <Tabs.Tab name="Информация" icon={<Info />}>
                        ...
                        employeeData?.data.length > 0 ? (
                            <div className="flex flex-col">
                                <p className="text-sm font-medium text-gray-900 dark:text-gray-400 mb-2">
                                    Сотрудники, которые работают в этой
                                    аудитории
                                </p>
                                <div className="flex flex-col space-y-4">
                                    {employeeData?.data.map(employee => (
                                        <div
                                            key={employee.id}
                                            className="flex flex-row tems-center space-x-2"
                                        >
