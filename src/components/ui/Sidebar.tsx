    ...
    >
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center">
          <Image src="mirea-gerb.svg" alt="РТУ МИРЭА герб" className="mr-2 h-8 w-auto" width={40} height={40} />
      ...
      <FbSidebar.CTA>
        ...
        <div className="mb-3 text-sm text-cyan-900 dark:text-gray-400">
          <p>Карта и навигация находится в постоянной разработке. Мы стараемся сделать её лучше.</p>
        </div>
        <Link
